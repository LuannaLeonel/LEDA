...
public class StudentSortingTest {
	...
	private void getImplementation() {
		...
		BidirectionalBubbleSort bidirectionalBubbleSort =  new BidirectionalBubbleSort();
		RecursiveBubbleSort recursiveBubbleSort = new RecursiveBubbleSort();
		RecursiveSelectionSort recursiveSelectionSort = new RecursiveSelectionSort();
		this.implementation = selectionSort;
