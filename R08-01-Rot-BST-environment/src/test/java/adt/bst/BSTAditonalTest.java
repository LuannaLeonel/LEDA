...
public class BSTAditonalTest {
    ...
    public void customTest() {
        ...
        assertTrue(bst.maximum().getData().equals(Integer.valueOf(250)));
        assertTrue(bst.minimum().getData().equals(Integer.valueOf(10)));
        ...
        assertTrue(bst.sucessor(bst.getRoot().getData()).getData().equals(Integer.valueOf(140)));
        assertNotNull(bst.predecessor(bst.getRoot().getData()));
        assertTrue(bst.predecessor(bst.getRoot().getData()).getData().equals(Integer.valueOf(75)));
        ...
        assertTrue(bst.predecessor(55).getData().equals(Integer.valueOf(50)));
        assertTrue(bst.predecessor(71).getData().equals(Integer.valueOf(70)));
        assertTrue(bst.sucessor(10).getData().equals(Integer.valueOf(25)));
        assertTrue(bst.predecessor(140).getData().equals(Integer.valueOf(100)));
        assertNull(bst.sucessor(250));
        assertNull(bst.predecessor(10));
        assertTrue(bst.sucessor(150).getData().equals(Integer.valueOf(180)));
        assertTrue(bst.predecessor(50).getData().equals(Integer.valueOf(25)));

        assertTrue(bst.predecessor(50).getData().equals(Integer.valueOf(25)));
        bst.remove(25);
        assertEquals(bst.height(), 5);
        assertEquals(bst.size(), 15);
        assertTrue(bst.predecessor(50).getData().equals(Integer.valueOf(10)));

        bst.remove(50);
        assertEquals(bst.height(), 5);
        assertEquals(bst.size(), 14);
        assertTrue(bst.sucessor(10).getData().equals(Integer.valueOf(55)));
        ...
        assertTrue(bst.predecessor(120).getData().equals(Integer.valueOf(100)));
        assertTrue(bst.sucessor(120).getData().equals(Integer.valueOf(125)));
